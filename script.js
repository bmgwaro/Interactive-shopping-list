document.addEventListener("DOMContentLoaded", () => {
  ...
  addButton.addEventListener("click", (event) => {
    ...
    if (shopping.trim().length !== 0 || !Number(shopping)) {
    ...
    shoppingList.forEach((item) => {
      ...
      document.getElementById("shopping_items").value = "";

      //this next callback function is for assigning purchased items if they are clicked
